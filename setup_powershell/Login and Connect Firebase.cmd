...
chcp 65001 >nul
title Linear Algebra Quiz - Login and Connect Firebase

set "SCRIPT_DIR=%~dp0"
set "POWERSHELL_SCRIPT=%SCRIPT_DIR%login-and-connect-firebase.ps1"
...
if not exist "%POWERSHELL_SCRIPT%" (
    ...
    echo   Login and Connect Firebase.cmd
    echo   login-and-connect-firebase.ps1
    echo.
    pause
    exit /b 1
)
...
if not "%EXIT_CODE%"=="0" (
    echo.
    echo The Firebase connection tool ended with an error.
