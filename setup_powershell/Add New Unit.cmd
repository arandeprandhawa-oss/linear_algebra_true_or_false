...
chcp 65001 >nul
title Linear Algebra Quiz - Add New Unit

set "SCRIPT_DIR=%~dp0"
set "POWERSHELL_SCRIPT=%SCRIPT_DIR%add-new-unit.ps1"
...
if not exist "%POWERSHELL_SCRIPT%" (
    ...
    echo   Add New Unit.cmd
    echo   add-new-unit.ps1
    echo.
    pause
    exit /b 1
)
...
if not "%EXIT_CODE%"=="0" (
    echo.
    echo The add-new-unit tool ended with an error.
